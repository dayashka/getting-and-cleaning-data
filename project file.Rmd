...
###### 1. Merge the training and the test sets to create one data set. 
setwd('C:/Users/amena/Documents/old laptop/g/data science/getting and cleaning data/Getting-and-Cleaning-Data-Week-4-Assignment-master/Getting-and-Cleaning-Data-Week-4-Assignment-master/UCI HAR Dataset') 
...
ergedDataSet <- MergedDataSet[,names(MergedDataSet) != 'activityType']; 
 ###### 5. Creates a second, independent tidy data set with the average of each variable for each activity and each subject. 
